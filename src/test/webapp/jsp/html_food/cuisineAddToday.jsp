		...
		<div class="layer_content" ng-controller="dataCtrl">
			...
			<form method="get" action="cuisineAddTodayOk.brn" class="style_corfrim" id="addok">
				...
				<span class="select_meal_time">
					<input type="radio" id="meal_morning" name="day" /><label for="meal_morning">아침</label>
					<input type="radio" id="meal_lunch"   name="day" /><label for="meal_lunch">점심</label>
					<input type="radio" id="meal_dinner"  name="day" /><label for="meal_dinner">저녁</label>
				</span>
				...
				<p class="col">
					...
					<!-- 칼로리 표시 -->
					<p class="txt_rslt">
						<!-- 칼로리 결과값 : name값은 알아서 바꾸길! !!!!!! -->
						총 {{ quantity }} 회 섭취 : 
						<input type="text" class="total_calory" name="total_calory" value="{{ quantity * cus_cal }}" readOnly /> 
						칼로리를 추가 하시겠습니까?
					</p>
				</p>
