   ...
   <section class="sub_container">
      ...
      <tbody>
               <!-- 반복문 시작 -->
                  ...
                  <tr>
                        <td class="nolist" colspan="6">검색된 게시물이 없습니다.</td>
                  </tr>
                  </c:if>
                  <!--검색된 게시물이 있는 경우-->
                  <c:if test="${listcount != 0}">
            ...
            <div class="paginate">
            <p>
               <a href="ebo_find_ok.brn?page=1" class="pre" title="맨앞">&lt;&lt;</a>
               <c:if test="${page <=1}">
                  <a href="#none" class="pre" title="이전페이지">&lt;</a>
               </c:if>
               <c:if test="${page > 1}">
                  <a href="ebo_find_ok.brn?page=${page-1}&limit=${limit}" class="pre" title="이전페이지">&lt;</a>
               </c:if>
               ...
               <c:forEach var="a" begin="${startpage}" end="${endpage}">
                  ...
                  <c:if test="${a != page }">
                     <a href="ebo_find_ok.brn?page=${a}&limit=${limit}" ><span>${a}</span></a>&nbsp;
                  </c:if>
               </c:forEach>
               <!--  -->
               ...
               <c:if test="${page < maxpage }">
                  <a href="ebo_find_ok.brn?page=${page+1}&limit=${limit}" class="next" title="다음페이지">&gt;</a>
               </c:if>   
               <a href="ebo_find_ok.brn?page=${maxpage}" class="pre" title="맨뒤">&gt;&gt;</a>
            </p>
         </div>
      ...
      <div class="btnB_area">
         <div class="fr">
            ...
            <p class="col">
               ...
               <input type="submit" class="btn_srch input_button" value="검색" />
            </p>
            </div>
            <!--한줄-->
            </form>
