...
<br/><br/>
제 1 조 (목적) <br/>
이 이용약관(이하 '약관')은 "Burning Fat"(이하 회사라 합니다)와 이용 고객(이하 '회원')간에 회사가 제공하는 서비스의 가입조건 및 이용에 관한 다음의 제반 사항과 기타 기본적인 사항을 구체적으로 규정함을 목적으로 합니다.
<br/><br/>
제 2 조 (이용약관의 효력 및 변경) <br/>
(1) 이 약관은 에서  "Burning Fat" 온라인으로 공시함으로써 효력을 발생하며, 합리적인 사유가 발생할 경우 관련법령에 위배되지 않는 범위 안에서 개정될 수 있습니다. 개정된 약관은 온라인에서 공지함으로써 효력을 발휘하며, 이용자의 권리 또는 의무 등 중요한 규정의 개정은 사전에 공지합니다.
...
<br/><br/>
제 4 조 (용어의 정의) <br/>
(1) "이용자" 또는”회원”이란  "Burning Fat"에 접속하여 본 약관에 따라  "Burning Fat"에 가입하여, 이용 고객의 식별과 이용고객의 서비스 이용을 위하여 이용고객 본인이 직접 선정하고 회사가 부여하는 문자와 숫자 조합인 ‘이용자번호(ID)’와 그에 따라 일치된 이용고객임을 확인하기 위하여 이용고객 본인이 선정한 ‘비밀번호’를 이용하여  "Burning Fat"이 제공하는 서비스를 받는 자를 말합니다.
(2) 이 약관에서 사용하는 용어의 정의는 제1항에서 정하는 것을 제외하고는 관계법령 및 서비스별 안내에서 정하는 바에 의합니다. 
<br/><br/>
제 2 장 이용계약 체결
<br/><br/>
제 5 조 (이용 계약의 성립)<br/>
(1) 이용계약은 이용고객의 본 이용약관 내용에 대한 동의와 이용신청에 대하여 회사의 이용승낙으로 성립하여 이용약관에 대한 동의는 이용신청 당시 해당  "Burning Fat" 웹의 '동의함' 버튼을 누름으로써 의사표시를 합니다.
<br/><br/>
제 6 조 (서비스 이용 신청) <br/>
...
회사는 관련법령이 정하는 바에 따라서 이용자 등록정보를 포함한 이용자의 개인정보를 보호하기 위하여 노력합니다. 이용자의 개인정보보호에 관해서는 관련법령 및  "Burning Fat"이 정하는 "개인정보보호정책"에 정한 바에 의합니다.
<br/><br/>
...
ㄱ. 가입신청자가 본 약관 의거하여 이전에 회원자격을 상실한 적이 있는 경우. 상실 후 1개월 경과 하지 않은  자로서  "Burning Fat"의 회원재가입 승낙을 얻으려 하는 경우
...
(3)  "Burning Fat"의 이용자ID는 이용자 본인의 동의하에  "Burning Fat" 가 운영하는 자사 사이트의 회원ID와 연결될 수 있습니다.
...
회원이 이용계약을 해지하고자 하는 때에는 회원 본인이  "Burning Fat" 웹 내의 [도움말] 메뉴를 이용해 가입해지를 해야 합니다. 
<br/><br/>
제 19 조 (서비스 이용제한) <br/>
...
(14) 회사는 회원이  "Burning Fat"을 이용함으로써 회원 본인 또는 제3자에게 직/간접적으로 영향을 미치게 되는 모든 피해와 법적 문제에 대하여 책임을 지지 않습니다.
<br/><br/>
제 22 조 (재판권 및 준거법)<br/>
...
<br/><br/>
						...
						<div class="agree_cont">
							<div class="cont">
							<p><br/><br/>"Burning Fat"에서  회원가입 관련하여「개인정보보호법」제15조제1항제1호, 제24조제1항제1호 따라 
							아래와 같이 개인정보의 수집·이용에 관하여 귀하의 동의를 얻고자 합니다.	<br/><br/>
							1. 수집·이용에 관한 사항<br/><br/>
							□ 수집·이용 목적<br/>
							"Burning Fat" 홈페이지 회원서비스 제공(문의응대 등)<br/>
							□ 수집·이용할 항목<br/>
							개인식별정보 - 필수사항 : 아이디, 비밀번호, 이름, 이메일, 성별, 생년월일<br/>
							□ 보유·이용기간 : 회원탈퇴 시 까지<br/>
							위 개인정보는 수집·이용에 관한 동의일로부터 보유목적 달성시 또는 정보주체가 개인정보 삭제를 요청할 경우 지체 없이 파기합니다.<br/>
							□ 동의를 거부할 권리 및 동의를 거부할 경우의 불이익<br/>
							위 개인정보의 수집·이용에 관한 동의는 회원가입 위해 필수적이므로 이에 동의하셔야 이후 절차를 진행할 수 있습니다. 
							<br/><br/>
							</p>
